...
import { redeemEarnPoints } from '../services/api';
import type { QrRedeemResponse } from '../types';

export default function ScanEarnPoints() {
      ...
      scanner.start(
        ...
        async (decodedText: string) => {
          try {
            ...
            setScanning(false);
            const res = await redeemEarnPoints(decodedText);
            setResult(res);
          } catch (err: any) {
  ...
  return (
    <div className="page">
      ...
      <div className="scan-container">
        <div className="scan-title">ポイント獲得</div>
        ...
        {result && (
          <div className="scan-result">
            <div className="scan-result-icon">🎉</div>
            <div className="scan-result-title">ポイント獲得！</div>
            <div className="scan-result-points">+{result.pointsEarned?.toLocaleString()} pt</div>
